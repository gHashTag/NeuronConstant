...
A: Единственный автор — Dmitrii Vasilev (admin@t27.ai). Весь RTL, Solidity, формальные доказательства и документация написаны PI. AI-инструменты использовались только как ассистенты при кодировании; интеллектуальный вклад и владение дизайном полностью принадлежат PI. См. Zenodo-архив ([DOI 10.5281/zenodo.19227877](https://doi.org/10.5281/zenodo.19227877)).
