...
> ## Tags
>
> - `tt-sky26b-final` pushed on all 5 repos (phi, euler, gamma, NeuronConstant, trinity-clara) on 2026-05-18 12:00 UTC after successful Submitted confirmation on app.tinytapeout.com
>
> ## Test pass count
>
...
## How to apply this update (READY 2026-05-18 12:00 UTC — all 3 Submitted)
...
6. Upload the final commit hashes manifest (see manifest section below) as `tt-sky26b-final-manifest.txt`
7. Optionally attach screenshots of Submitted dashboard
8. Publish — new DOI version will be auto-issued, old DOI redirects
...
Repository commit hashes:
  ...
  NeuronConstant    : 522873c41acb56349f9b345c0ed4d9a07427961b
...
tt_submission artifact IDs (GitHub Actions):
  ...
  gamma : 7056692733 (16.3 MB)

TinyTapeout submission status (verified 2026-05-18 12:00 UTC):
  phi   : Submitted (1×1 tile)
  euler : Submitted (8×2 tile)
  gamma : Submitted (8×4 tile)
  Total tiles allocated/used: 49/49
  DevKits purchased: 3
